...
# my new action  OFPAT_SELF_LEARNING = 30
OFP_ACTION_SELF_LEARNING_PACK_STR = '!HHI'
OFP_ACTION_SELF_LEARNING_SIZE = 8
assert calcsize(OFP_ACTION_SELF_LEARNING_PACK_STR) ==
    OFP_ACTION_SELF_LEARNING_SIZE
